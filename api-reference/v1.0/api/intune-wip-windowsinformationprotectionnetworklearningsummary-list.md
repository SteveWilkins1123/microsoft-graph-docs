...
<!-- { "blockType": "request" , "name" : "list_windowsinformationprotectionnetworklearningsummaries" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.windowsInformationProtectionNetworkLearningSummaries" }-->
``` http
HTTP/1.1 200 OK
