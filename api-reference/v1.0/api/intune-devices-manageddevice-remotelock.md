...
POST /deviceManagement/detectedApps/{detectedAppId}/managedDevices/{managedDeviceId}/users/{userId}/managedDevices/{managedDeviceId}/remoteLock
```
...
<!-- { "blockType": "request" , "name" : "remotelock_action" }-->
``` http
