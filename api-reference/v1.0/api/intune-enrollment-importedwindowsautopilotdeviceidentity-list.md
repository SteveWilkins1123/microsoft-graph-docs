...
<!-- { "blockType": "request" , "name" : "list_importedwindowsautopilotdeviceidentities" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.importedWindowsAutopilotDeviceIdentities" }-->
``` http
HTTP/1.1 200 OK
