...
## Response
If successful, this method returns a `200 OK` response code and [termsAndConditionsAssignment](../resources/intune-companyterms-termsandconditionsassignment.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_termsandconditionsassignment" }-->
``` http
