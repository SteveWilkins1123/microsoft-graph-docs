...
<!-- { "blockType": "request" , "name" : "list_windowsinformationprotectionapplearningsummaries" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.windowsInformationProtectionAppLearningSummaries" }-->
``` http
HTTP/1.1 200 OK
