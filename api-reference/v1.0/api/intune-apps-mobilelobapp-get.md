...
## Response
If successful, this method returns a `200 OK` response code and [mobileLobApp](../resources/intune-apps-mobilelobapp.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_mobilelobapp" }-->
``` http
