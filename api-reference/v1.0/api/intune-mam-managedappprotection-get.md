...
## Response
If successful, this method returns a `200 OK` response code and [managedAppProtection](../resources/intune-mam-managedappprotection.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_managedappprotection" }-->
``` http
