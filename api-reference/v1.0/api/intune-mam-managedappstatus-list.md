...
## Response
If successful, this method returns a `200 OK` response code and a collection of [managedAppStatus](../resources/intune-mam-managedappstatus.md) objects in the response body.
...
<!-- { "blockType": "request" , "name" : "list_managedappstatuses" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.managedAppStatuses" }-->
``` http
HTTP/1.1 200 OK
