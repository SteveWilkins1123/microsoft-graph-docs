...
## Response
If successful, this method returns a `200 OK` response code and [iosCertificateProfile](../resources/intune-deviceconfig-ioscertificateprofile.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_ioscertificateprofile" }-->
``` http
