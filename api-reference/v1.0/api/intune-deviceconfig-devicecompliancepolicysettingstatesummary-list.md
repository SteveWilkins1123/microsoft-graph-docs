...
<!-- { "blockType": "request" , "name" : "list_devicecompliancepolicysettingstatesummaries" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.deviceCompliancePolicySettingStateSummaries" }-->
``` http
HTTP/1.1 200 OK
