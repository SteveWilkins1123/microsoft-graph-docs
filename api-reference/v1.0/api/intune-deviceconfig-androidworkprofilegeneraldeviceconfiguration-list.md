...
<!-- { "blockType": "request" , "name" : "list_androidworkprofilegeneraldeviceconfigurations" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.androidWorkProfileGeneralDeviceConfigurations" }-->
``` http
HTTP/1.1 200 OK
