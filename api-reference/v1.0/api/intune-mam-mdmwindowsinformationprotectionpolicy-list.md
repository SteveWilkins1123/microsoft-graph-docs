...
<!-- { "blockType": "request" , "name" : "list_mdmwindowsinformationprotectionpolicies" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.mdmWindowsInformationProtectionPolicies" }-->
``` http
HTTP/1.1 200 OK
