...
## Response
If successful, this method returns a `200 OK` response code and [deviceManagement](../resources/intune-tem-devicemanagement.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_devicemanagement" }-->
``` http
