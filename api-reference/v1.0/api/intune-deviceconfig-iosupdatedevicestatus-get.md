...
## Response
If successful, this method returns a `200 OK` response code and [iosUpdateDeviceStatus](../resources/intune-deviceconfig-iosupdatedevicestatus.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_iosupdatedevicestatus" }-->
``` http
