...
<!-- { "blockType": "request" , "name" : "list_windows10secureassessmentconfigurations" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.windows10SecureAssessmentConfigurations" }-->
``` http
HTTP/1.1 200 OK
