...
<!-- { "blockType": "request" , "name" : "list_deviceenrollmentplatformrestrictionsconfigurations" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.deviceEnrollmentPlatformRestrictionsConfigurations" }-->
``` http
HTTP/1.1 200 OK
