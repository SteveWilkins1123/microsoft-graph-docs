...
## Response
If successful, this method returns a `200 OK` response code and [localizedNotificationMessage](../resources/intune-notification-localizednotificationmessage.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_localizednotificationmessage" }-->
``` http
