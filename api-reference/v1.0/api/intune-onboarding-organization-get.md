...
## Response
If successful, this method returns a `200 OK` response code and [organization](../resources/intune-onboarding-organization.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_organization" }-->
``` http
