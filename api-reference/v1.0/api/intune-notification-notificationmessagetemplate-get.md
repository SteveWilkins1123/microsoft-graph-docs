...
## Response
If successful, this method returns a `200 OK` response code and [notificationMessageTemplate](../resources/intune-notification-notificationmessagetemplate.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_notificationmessagetemplate" }-->
``` http
