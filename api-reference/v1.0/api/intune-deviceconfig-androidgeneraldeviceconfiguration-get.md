...
## Response
If successful, this method returns a `200 OK` response code and [androidGeneralDeviceConfiguration](../resources/intune-deviceconfig-androidgeneraldeviceconfiguration.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_androidgeneraldeviceconfiguration" }-->
``` http
