...
## Response
If successful, this method returns a `200 OK` response code and a collection of [managedDeviceMobileAppConfigurationUserStatus](../resources/intune-apps-manageddevicemobileappconfigurationuserstatus.md) objects in the response body.
...
<!-- { "blockType": "request" , "name" : "list_manageddevicemobileappconfigurationuserstatuses" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.managedDeviceMobileAppConfigurationUserStatuses" }-->
``` http
HTTP/1.1 200 OK
