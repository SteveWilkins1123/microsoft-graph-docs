...
## Response
If successful, this method returns a `200 OK` response code and a collection of [iosUpdateDeviceStatus](../resources/intune-deviceconfig-iosupdatedevicestatus.md) objects in the response body.
...
<!-- { "blockType": "request" , "name" : "list_iosupdatedevicestatuses" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.iosUpdateDeviceStatuses" }-->
``` http
HTTP/1.1 200 OK
