...
## Response
If successful, this method returns a `200 OK` response code and [deviceComplianceSettingState](../resources/intune-deviceconfig-devicecompliancesettingstate.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_devicecompliancesettingstate" }-->
``` http
