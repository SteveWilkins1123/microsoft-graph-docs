...
## Response
If successful, this method returns a `200 OK` response code and a collection of [vppToken](../resources/intune-onboarding-vpptoken.md) objects in the response body.
...
<!-- { "blockType": "request" , "name" : "list_vpptokens" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.vppTokens" }-->
``` http
HTTP/1.1 200 OK
