...
## Response
If successful, this method returns a `200 OK` response code and a collection of [deviceComplianceUserStatus](../resources/intune-deviceconfig-devicecomplianceuserstatus.md) objects in the response body.
...
<!-- { "blockType": "request" , "name" : "list_devicecomplianceuserstatuses" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.deviceComplianceUserStatuses" }-->
``` http
HTTP/1.1 200 OK
