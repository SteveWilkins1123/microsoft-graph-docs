...
## Response
If successful, this method returns a `200 OK` response code and [androidStoreApp](../resources/intune-apps-androidstoreapp.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_androidstoreapp" }-->
``` http
