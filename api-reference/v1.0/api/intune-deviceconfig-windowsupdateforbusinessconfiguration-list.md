...
<!-- { "blockType": "request" , "name" : "list_windowsupdateforbusinessconfigurations" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.windowsUpdateForBusinessConfigurations" }-->
``` http
HTTP/1.1 200 OK
