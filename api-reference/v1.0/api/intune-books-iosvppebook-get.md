...
## Response
If successful, this method returns a `200 OK` response code and [iosVppEBook](../resources/intune-books-iosvppebook.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_iosvppebook" }-->
``` http
