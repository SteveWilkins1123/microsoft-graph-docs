...
<!-- { "blockType": "request" , "name" : "list_windows10endpointprotectionconfigurations" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.windows10EndpointProtectionConfigurations" }-->
``` http
HTTP/1.1 200 OK
