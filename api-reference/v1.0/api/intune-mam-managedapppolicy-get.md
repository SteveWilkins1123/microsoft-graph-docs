...
## Response
If successful, this method returns a `200 OK` response code and [managedAppPolicy](../resources/intune-mam-managedapppolicy.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_managedapppolicy" }-->
``` http
