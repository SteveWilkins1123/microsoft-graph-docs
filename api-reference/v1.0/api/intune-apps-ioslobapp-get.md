...
## Response
If successful, this method returns a `200 OK` response code and [iosLobApp](../resources/intune-apps-ioslobapp.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_ioslobapp" }-->
``` http
