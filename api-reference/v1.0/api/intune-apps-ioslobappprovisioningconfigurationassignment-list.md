...
<!-- { "blockType": "request" , "name" : "list_ioslobappprovisioningconfigurationassignments" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.iosLobAppProvisioningConfigurationAssignments" }-->
``` http
HTTP/1.1 200 OK
