...
## Response
If successful, this method returns a `200 OK` response code and a collection of [deviceComplianceActionItem](../resources/intune-deviceconfig-devicecomplianceactionitem.md) objects in the response body.
...
<!-- { "blockType": "request" , "name" : "list_devicecomplianceactionitems" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.deviceComplianceActionItems" }-->
``` http
HTTP/1.1 200 OK
