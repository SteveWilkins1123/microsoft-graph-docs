...
## Response
If successful, this method returns a `200 OK` response code and [managedApp](../resources/intune-apps-managedapp.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_managedapp" }-->
``` http
