...
## Response
If successful, this method returns a `200 OK` response code and [macOSCustomConfiguration](../resources/intune-deviceconfig-macoscustomconfiguration.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_macoscustomconfiguration" }-->
``` http
