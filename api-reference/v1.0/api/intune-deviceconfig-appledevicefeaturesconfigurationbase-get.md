...
## Response
If successful, this method returns a `200 OK` response code and [appleDeviceFeaturesConfigurationBase](../resources/intune-deviceconfig-appledevicefeaturesconfigurationbase.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_appledevicefeaturesconfigurationbase" }-->
``` http
