...
## Response
If successful, this method returns a `200 OK` response code and [managedIOSStoreApp](../resources/intune-apps-managediosstoreapp.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_managediosstoreapp" }-->
``` http
