...
<!-- { "blockType": "request" , "name" : "list_devicecompliancescheduledactionforrules" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.deviceComplianceScheduledActionForRules" }-->
``` http
HTTP/1.1 200 OK
