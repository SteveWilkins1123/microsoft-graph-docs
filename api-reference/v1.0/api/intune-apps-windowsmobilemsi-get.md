...
## Response
If successful, this method returns a `200 OK` response code and [windowsMobileMSI](../resources/intune-apps-windowsmobilemsi.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_windowsmobilemsi" }-->
``` http
