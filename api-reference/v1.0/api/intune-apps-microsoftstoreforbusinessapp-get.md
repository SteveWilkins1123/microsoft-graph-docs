...
## Response
If successful, this method returns a `200 OK` response code and [microsoftStoreForBusinessApp](../resources/intune-apps-microsoftstoreforbusinessapp.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "get_microsoftstoreforbusinessapp" }-->
``` http
