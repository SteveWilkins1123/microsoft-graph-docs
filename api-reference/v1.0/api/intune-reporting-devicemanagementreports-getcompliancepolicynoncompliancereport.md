---
title: "getCompliancePolicyNonComplianceReport action"
...
# getCompliancePolicyNonComplianceReport action
...
<!-- { "blockType": "request" , "name" : "getcompliancepolicynoncompliancereport_action" }-->
``` http
