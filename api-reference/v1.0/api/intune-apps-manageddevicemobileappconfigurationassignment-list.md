...
<!-- { "blockType": "request" , "name" : "list_manageddevicemobileappconfigurationassignments" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.managedDeviceMobileAppConfigurationAssignments" }-->
``` http
HTTP/1.1 200 OK
