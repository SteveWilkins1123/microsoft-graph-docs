...
<!-- { "blockType": "request" , "name" : "list_manageddevicemobileappconfigurationdevicestatuses" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.managedDeviceMobileAppConfigurationDeviceStatuses" }-->
``` http
HTTP/1.1 200 OK
