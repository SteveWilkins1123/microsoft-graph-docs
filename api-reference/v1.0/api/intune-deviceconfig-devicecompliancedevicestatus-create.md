...
## Response
If successful, this method returns a `201 Created` response code and a [deviceComplianceDeviceStatus](../resources/intune-deviceconfig-devicecompliancedevicestatus.md) object in the response body.
...
<!-- { "blockType": "request" , "name" : "create_devicecompliancedevicestatus" }-->
``` http
