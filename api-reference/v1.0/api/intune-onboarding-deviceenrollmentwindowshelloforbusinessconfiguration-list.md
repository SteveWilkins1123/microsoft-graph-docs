...
<!-- { "blockType": "request" , "name" : "list_deviceenrollmentwindowshelloforbusinessconfigurations" }-->
``` http
...
<!-- { "blockType": "response" , "@odata.type" : "microsoft.graph.deviceEnrollmentWindowsHelloForBusinessConfigurations" }-->
``` http
HTTP/1.1 200 OK
